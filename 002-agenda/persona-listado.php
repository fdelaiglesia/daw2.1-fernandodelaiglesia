	...
	<?php
        foreach ($personas as $filaUnica) { ?>
			<tr>
				...
				<td><a href="persona-eliminar.php?id=<?=$filaUnica["p_id"]?>"> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
